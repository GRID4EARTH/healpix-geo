...
mod nested {
    ...
    use crate::indexing_schemes::nested::{
        ...
        cone_coverage, elliptical_cone_coverage, face_neighbour_transform, healpix_to_cartesian, healpix_to_lonlat,
        internal_boundary, kth_neighbourhood, kth_neighbours, lonlat_to_healpix, neighbours, pix2xyf, xyf2pix,
