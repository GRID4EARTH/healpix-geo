...
mod nested {
    ...
    use crate::indexing_schemes::nested::{
        angular_distances, base_cell_relationship, bilinear_interpolation, box_coverage,
        cartesian_to_healpix, cone_coverage, elliptical_cone_coverage, healpix_to_cartesian,
